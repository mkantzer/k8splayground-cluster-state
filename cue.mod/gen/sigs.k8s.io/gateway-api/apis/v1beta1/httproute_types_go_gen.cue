...
#HTTPRouteSpec: {
	...
	rules?: [...#HTTPRouteRule] @go(Rules,[]HTTPRouteRule)
}
...
#HTTPRouteMatch: {
	...
	// +optional
	// +kubebuilder:validation:MaxItems=16
	headers?: [...#HTTPHeaderMatch] @go(Headers,[]HTTPHeaderMatch)
	...
	// +optional
	// +kubebuilder:validation:MaxItems=16
	queryParams?: [...#HTTPQueryParamMatch] @go(QueryParams,[]HTTPQueryParamMatch)
...
#HTTPHeaderFilter: {
	...
	// +listMapKey=name
	// +kubebuilder:validation:MaxItems=16
	set?: [...#HTTPHeader] @go(Set,[]HTTPHeader)
	...
	// +listMapKey=name
	// +kubebuilder:validation:MaxItems=16
	add?: [...#HTTPHeader] @go(Add,[]HTTPHeader)
