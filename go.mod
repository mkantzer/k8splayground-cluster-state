...
// Manually created: https://argo-cd.readthedocs.io/en/stable/user-guide/import/
// (Old) Actual Source: https://github.com/argoproj/argo-cd/blob/v2.6.7/go.mod#L259
// Current Actual Source: https://github.com/argoproj/argo-rollouts/blob/v1.5.1/go.mod#L196C1-L223C2
// We're uing the rollouts block because it's more up to date, and it actually works with both argo apps:
// There's a weird colision in the kubectl(?) package.
replace (
